...
public final class FirstPartTasks {
    ...
    public static List<String> allNamesSorted(Stream<Album> albums) {
        return albums.map(Album::getName).sorted()
    ...
    public static List<Album> sortedFavorites(Stream<Album> albums) {
        Predicate<Album> predicate = a -> a.getTracks().stream()
    ...
    public static List<Album> sortByAverageRating(Stream<Album> albums) {
        Function<Album, Double> compareFunction = a -> a.getTracks().stream().collect(
                Collectors.averagingDouble(Track::getRating));

        return albums.sorted(Comparator.comparing(compareFunction).reversed())
                .collect(Collectors.toList());
    }
